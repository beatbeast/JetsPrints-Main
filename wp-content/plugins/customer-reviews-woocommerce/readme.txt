...
3. A sample email with an invitation to review products
4. A sample review form generated by the plugin
5. A sample email with a discount code
6. The reviews summary bar
7. Voting buttons for reviews
8. A Trust Badge block to showcase a summary of verified reviews
9. A button to attach pictures to reviews
10. reCAPTCHA field to prevent fake reviews
11. A customer review with a picture
12. [cusrev_reviews_slider] shortcode to display a responsive reviews slider on any page or post of a website
13. [cusrev_all_reviews] shortcode to display reviews for all products on any page or post of a website
14. [cusrev_reviews_grid] shortcode to display a grid of product reviews on any page or post of a website
