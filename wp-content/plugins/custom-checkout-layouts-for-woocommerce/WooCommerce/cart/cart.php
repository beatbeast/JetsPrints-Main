	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-name"><?php esc_html_e( 'Product', 'cclw' ); ?></th>
				<th class="product-price"><?php esc_html_e( 'Price', 'cclw' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Quantity', 'cclw' ); ?></th>
				<th class="product-subtotal"><?php esc_html_e( 'Total', 'cclw' ); ?></th>
		...
		<tbody>
			...
			<tr class="avada-cart-actions">
				<td colspan="6" class="actions">
					...
					<button type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'cclw' ); ?>"><?php esc_html_e( 'Update cart', 'cclw' ); ?></button>
